    ...
    <div className="min-h-screen flex flex-col lg:flex-row items-center justify-center bg-blue-50 p-4 sm:p-6 lg:p-8 gap-12">
      ...
      <div className="w-full max-w-md">
        <div className="text-center lg:text-left">
          ...
          <p className="text-lg text-gray-700 mb-8">
            Welcome to eShop - Your ultimate online shopping destination! Discover amazing deals on thousands of products across fashion, electronics, home essentials, and more. Enjoy fast shipping, easy returns, and secure payments. Start your shopping journey with us today!
          </p>
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8">
        ...
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-800 text-center">Welcome back to eShop</h2>
        </div>
          ...
          <div>
            <a href="#" className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors duration-200">
              ...
              <svg className="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12.48 10.92v3.28h7.84c-.24 1.84-.853 3.187-1.787 4.133-1.147 1.147-2.933 2.4-6.053 2.4-4.827 0-8.6-3.893-8.6-8.72s3.773-8.72 8.6-8.72c2.6 0 4.507 1.027 5.907 2.347l2.307-2.307C18.747 1.44 16.133 0 12.48 0 5.867 0 .307 5.387.307 12s5.56 12 12.173 12c3.573 0 6.267-1.173 8.373-3.36 2.16-2.16 2.84-5.213 2.84-7.667 2.84-7.667 0-.76-.053-1.467-.173-2.053H12.48z" />
              </svg>
            </a>
          </div>
          <div>
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-center text-xs text-gray-500">
            By continuing, you agree to eShop's Terms of Service and Privacy Policy
          </p>
        </div>
      </div>
    </div>
