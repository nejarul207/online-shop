...
const Footer = () => {
    ...
    const linkSections = [
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "+880 1986249491", path: '/', icon: MailIcon },
                { text: "eshop@gmail.com", path: '/', icon: PhoneIcon },
                { text: "Barishal, Bangladesh", path: '/', icon: MapPinIcon }
            ]
        }
    ];
    ...
    return (
        <footer className="pt-12 pb-5 px-6 bg-green-50">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        ...
                        <p className="max-w-[410px] mt-6 text-sm">Welcome to eShop, your ultimate destination for the latest and smartest gadgets. From smartphones and smartwatches to essential accessories, we bring you the best in innovation — all in one place.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © eShop All Right Reserved.
                </p>
            </div>
        </footer>
    );
